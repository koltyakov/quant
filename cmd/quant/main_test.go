...
func TestResolveCommand(t *testing.T) {
	tests := []struct {
		...
		{name: "explicit init", args: []string{"init", "codex"}, wantCmd: "init", wantArgs: []string{"codex"}},
		{name: "explicit launch", args: []string{"launch", "codex"}, wantCmd: "launch", wantArgs: []string{"codex"}},
		...
		{name: "init help command", args: []string{"help", "init"}, wantCmd: "init-help"},
		{name: "init help flag", args: []string{"init", "--help"}, wantCmd: "init-help"},
		{name: "launch help command", args: []string{"help", "launch"}, wantCmd: "launch-help"},
		{name: "launch help flag", args: []string{"launch", "--help"}, wantCmd: "launch-help"},
